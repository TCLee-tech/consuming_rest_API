...
public class AzureSentimentService {
	...
	//@Value("${AZURE_API_KEY}") use this if AZURE_API_KEY stored in environment variable
	private String azureApiKey = "";
		
	@Autowired
	private ObjectMapper mapper;
	
	private static final String AZURE_ENDPOINT = "https://xxxxxxxx.cognitiveservices.azure.com/"; //get from your Azure portal
	...
	public SentimentAnalysis requestSentimentAnalysis(String text, String language) throws IOException, InterruptedException {
		...
		TextDocument document = new TextDocument("1",text,language); // new TextDocument Object
		TextAnalyticsRequest requestBody = new TextAnalyticsRequest(); // new List<TextDocument>
		requestBody.getDocuments().add(document); //get and add new TextDocument to new List<TextDocument>
