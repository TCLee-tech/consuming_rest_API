...
public class StreamingSentimentAnalysisApplication implements CommandLineRunner {
	...
	public static void main(String[] args) {
		SpringApplication.run(StreamingSentimentAnalysisApplication.class, args);
	}
	...
	public void run(String... args) throws Exception {
		...
		this.twitterStreamingService.stream().subscribe(tweet -> {
			...
			String message = analysis.getSentiment().equalsIgnoreCase("positive")
				? "Ethereum received good feedback on Twitter!" : "Ethereum received bad feedback on Twitter!";
				//change message as required
